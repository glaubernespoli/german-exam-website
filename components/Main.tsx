  ...
  return (
    <section className="text-gray-600 body-font">
      ...
      <p className="mx-auto text-xl font-normal leading-relaxed text-center text-gray-300 fs521 lg:w-2/3">
        Here is our collection of free to use templates made with Next.js & styled with Tailwind CSS.
      </p>
      ...
      <div className="max-w-6xl px-3 pt-32 pb-32 mx-auto fsac4 md:px-1">
        <div className="ktq4">
          ...
          <h3 className="pt-3 text-lg font-semibold text-white">Lorem ipsum dolor sit amet</h3>
          <p className="pt-2 text-gray-200 value-text text-md fkrr1">
            Fusce pharetra ligula mauris, quis faucibus lectus elementum vel. Nullam vehicula, libero at euismod
            tristique, neque ligula faucibus urna, quis ultricies massa enim in nunc. Vivamus ultricies, quam ut rutrum
            blandit, turpis massa ornare velit, in sodales tellus ex nec odio.
          </p>
        </div>
        <div className="ktq4">
          <img src="https://nine4.app/images/nine4-3.png"></img>
      ...
      <section className="relative pb-24">
        <div className="max-w-6xl px-4 mx-auto text-center sm:px-6">
          <div className="py-24 md:py-36">
            <h1 className="mb-5 text-6xl font-bold text-white">Subscribe to our newsletter</h1>
            <h1 className="text-2xl font-semibold text-gray-200 mb-9">
            ...
            <input
              ...
              name="email"
              autoComplete="email"
              className="w-1/4 py-3 pl-2 pr-2 mt-2 font-semibold text-gray-800 bg-black border border-gray-600 rounded-md hover:border-gray-700"
            />{" "}
            <a
              className="inline-flex items-center py-3 mt-2 ml-2 font-medium text-black transition duration-500 ease-in-out transform bg-transparent bg-white border rounded-lg px-14"
              href="/"
            >
